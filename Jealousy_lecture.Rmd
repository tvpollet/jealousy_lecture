...
* Discussing a classic paper on 'Jealousy'.

* Other research following this classic.
...
If finished: have a look [here](https://www.slideshare.net/PETRUSALMEIDUS/the-evolution-of-jelousy)
...
Three studies on sex differences in jealousy (2 studies based on surveys and one based on physiological measures (e.g., EMG))
...
knitr::include_graphics("https://media.giphy.com/media/4xpB3eE00FfBm/giphy.gif")
```
...
Harris (2002) used a sample of people who experienced infidelity (N=150).
...
* A (mini-)meta-analytic synthesis by Ijzerman et al. (2014): looking specifically at older vs. younger samples.
...
Four studies totaling around 2,000 participants + mini-meta-analysis.



```{r, out.width = "625px", echo=FALSE, fig.align='center'}
...
* Is this pattern stable over time? (Old versus young samples?)

--

* Is there something different about new relationship forms (or is it similar to previous forms (e.g. open marriages, Buunk (1980, 1981))?
...
???
Measurement of jealousy. Interpretation of infidelity. Life experiences.
...
Twitter: @tvpollet / please promote our survey: https://nupsych.qualtrics.com/jfe/form/SV_b89noHMiMolQcFn
